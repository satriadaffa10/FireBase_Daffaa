...
public class DBCreatee extends AppCompatActivity
{
...
Spinner etJa;
    ...
    protected void onCreate(@Nullable Bundle
        ...
        setContentView(R.layout.activity_dbcreatee);
// inisialisasi fields EditText dan Button
        etNik = (EditText) findViewById(R.id.nik);
        etNama = (EditText)
                findViewById(R.id.nama_dosen);etJa =
...
// kode yang dipanggil ketika tombol Submit diklik
        btSubmit.setOnClickListener(new
...
// kode untuk pengambilan Intent
        return new Intent(activity, DBCreatee.class);
    }
}
